(function ($) {
    ...
    $.fn.tautocomplete = function (options, callback) {
        ...
        var tautocomplete = {
            ...
            permission: function () {
                return el.ddTextbox.data("permission");
            },
            introduce: function () {
                return el.ddTextbox.data("introduce");
            },
            searchdata: function () {
        ...
        // assign data fields to the textbox, helpful in case of .net postbacks
        {
            ...
            el.ddTextbox.attr("data-permission", permission);
            el.ddTextbox.val(permission);
        }
        ...
        el.ddTextbox.focusout(function () {
            ...
            if ($(this).val() != $(this).data("permission")) {
        ...
        function select() {
            ...
            el.ddTextbox.data("permission", selected.find('td').eq(1).text());
            el.ddTextbox.data("introduce", selected.find('td').eq(2).text());
